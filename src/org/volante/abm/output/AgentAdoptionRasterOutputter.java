 ...
 * 
 */
public class AgentAdoptionRasterOutputter extends RasterOutputter {
	...
	public double apply(Cell c) {
		...
		if (c.getOwner() instanceof InnovationAgent) {
			return ((InnovationAgent) c.getOwner()).getState(this.innovation) == InnovationStates.ADOPTED ? 1
					: 0;
		} else {
			return 0;
		}
