...
public class DefaultAgent extends AbstractAgent {
	...
	public DefaultAgent(FunctionalRole fRole, String id, ModelData data,
		...
		this(fRole, id, data, r, fRole.getProduction(), fRole
				.getAssociatedGivingInThreshold(),
				fRole.getAssociatedGivingInThreshold());
	}
	...
	public void considerGivingUp() {
		if (this.propertyProvider.getProperty(AgentPropertyIds.COMPETITIVENESS) < this.propertyProvider
