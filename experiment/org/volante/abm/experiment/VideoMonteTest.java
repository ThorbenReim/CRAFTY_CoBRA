...
public class VideoMonteTest
{
    ...
    public static void main(String[] args) {
        System.out.println("AVIDemo "+VideoMonteTest.class.getPackage().getImplementationVersion());
        ...
        try {
            test(new File("output/avidemo-jpg.avi"), new Format(EncodingKey, ENCODING_AVI_MJPG, DepthKey, 24, QualityKey, 1f));
            test(new File("output/avidemo-png.avi"), new Format(EncodingKey, ENCODING_AVI_PNG, DepthKey, 24));
            test(new File("output/avidemo-raw24.avi"), new Format(EncodingKey, ENCODING_AVI_DIB, DepthKey, 24));
            test(new File("output/avidemo-raw8.avi"), new Format(EncodingKey, ENCODING_AVI_DIB, DepthKey, 8));
            test(new File("output/avidemo-rle8.avi"), new Format(EncodingKey, ENCODING_AVI_RLE, DepthKey, 8));
            test(new File("output/avidemo-tscc8.avi"), new Format(EncodingKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE, DepthKey, 8));
            test(new File("output/avidemo-tscc24.avi"), new Format(EncodingKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE, DepthKey, 24));
